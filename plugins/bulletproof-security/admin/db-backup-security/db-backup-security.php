...
<?php
	...
	echo '<input type="text" name="DBBDescription" class="regular-text-short-fixed" style="width:500px;margin:0px 0px 10px 0px;" value="'.esc_html($DBBDescription).'" /><br>';
	...
	echo '<input type="text" name="DBBFolder" class="regular-text-short-fixed" style="width:500px;margin:0px 0px 10px 0px;" value="'; if ( preg_match( '|[<>\"\';]|', @$_POST['DBBFolder'] ) ) { echo esc_html($DBBoptions['bps_db_backup_folder']); } else { echo esc_html(trim(stripslashes($DBBFolder))); } echo '" /><br>';	
	...
	echo '<input type="text" name="DBBDownloadLink" class="regular-text-short-fixed" style="width:500px;margin:0px 0px 10px 0px;" value="'; if ( preg_match( '|[<>\"\';]|', @$_POST['DBBDownloadLink'] ) ) { echo esc_url($DBBoptions['bps_db_backup_download_link']); } else { echo esc_url(trim($DBBDownloadLink)); } echo '" /><br>';
...
<table border="0">
  <tr>
    ...
    <td><input type="text" name="bulletproof_security_options_email[bps_send_email_to]" class="regular-text-long-fixed" style="width:200px;" value="<?php if ( $options['bps_send_email_to'] != '' ) { echo esc_html( $options['bps_send_email_to'] ); } else { echo esc_html( $admin_email ); } ?>" /></td>
  </tr>
  <tr>
    <td><label for="bps-monitor-email"><?php _e('Send Email Alerts & Log Files From:', 'bulletproof-security'); ?> </label></td>
    <td><input type="text" name="bulletproof_security_options_email[bps_send_email_from]" class="regular-text-long-fixed" style="width:200px;" value="<?php if ( $options['bps_send_email_from'] != '' ) { echo esc_html( $options['bps_send_email_from'] ); } else { echo esc_html( $admin_email ); } ?>" /></td>
  </tr>
  <tr>
    <td><label for="bps-monitor-email"><?php _e('Send Email Alerts & Log Files Cc:', 'bulletproof-security'); ?> </label></td>
    <td><input type="text" name="bulletproof_security_options_email[bps_send_email_cc]" class="regular-text-long-fixed" style="width:200px;" value="<?php echo esc_html( $options['bps_send_email_cc'] ); ?>" /></td>
  </tr>
  <tr>
    <td><label for="bps-monitor-email"><?php _e('Send Email Alerts & Log Files Bcc:', 'bulletproof-security'); ?> </label></td>
    <td><input type="text" name="bulletproof_security_options_email[bps_send_email_bcc]" class="regular-text-long-fixed" style="width:200px;" value="<?php echo esc_html( $options['bps_send_email_bcc'] ); ?>" /></td>
  </tr>
</table>
<br />
...
<input type="text" style="width:215px;" name="DBTablePrefix" value="<?php if ( preg_match( '|[^a-z0-9_]|', @$_POST['DBTablePrefix'] ) ) { echo esc_html($prefix_obs); } else { echo esc_html($DBTablePrefix); } ?>" class="regular-text-short-fixed" /> <br />
<p class="submit">

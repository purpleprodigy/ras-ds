...
if ( isset( $_POST['Submit-Maintenance-Mode-Form'] ) && current_user_can('manage_options') ) {
	...
	if ( $_POST['mmode_time'] == '' && $_POST['mmode_countdown_timer'] == '1' ) {
		echo $bps_topDiv;
	...
	'bps_maint_log_visitors' 			=> $_POST['mmode_log_visitors'], 

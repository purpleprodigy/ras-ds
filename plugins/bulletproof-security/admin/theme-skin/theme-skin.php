...
<h2 style="margin-left:220px;"><?php _e('BulletProof Security ~ UI|UX Settings', 'bulletproof-security'); ?></h2>
...
<div id="Status-Display" style="width:340px;">
...
<div id="BPS-Debug" style="width:340px;">
<form name="bps-debug" action="options.php" method="post">
	...
	<label for="debug"><?php _e('BPS UI|UX Debug:', 'bulletproof-security'); ?></label><br />
	<label for="debug" style="color:#2ea2cc;"><?php _e('Click the Read Me help button for information', 'bulletproof-security'); ?></label><br />
<select name="bulletproof_security_options_debug[bps_debug]" style="width:265px;">

...
add_action( 'genesis_before_while', __NAMESPACE__ . '\add_custom_form_contents' );
/**
 ...
 * @return void
 */
function add_custom_form_contents() {
	...
	include( CHILD_THEME_DIR . '/lib/views/ras-ds-form.php' );
}
